  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold hn-gradient-text">404</h1>
        <h2 className="mt-4 text-xl font-semibold text-foreground">Signal lost</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This node is not part of the HN Platform yet.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          A subsystem failed to boot
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          HN Core caught the error. You can retry or return to the Dashboard.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HN Platform — The Digital Operating System for HN Ecosystem" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "HN Platform — The Digital Operating System for HN Ecosystem" },
      {
        ...
        content:
          "One core to orchestrate every HN application, agent, database and workflow.",
      },
